...
- After a try, a transformation kick is played and is worth 2 extra points if
  successful
...
- **N lines**: number of tries, number of transformations,
  number of penalties / drops, separated by spaces
