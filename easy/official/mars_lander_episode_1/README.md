...
$3.711 m/s^2$. For a **thrust power of X**, a push force equivalent to
$X m/s^2$ is generated and **X liters of fuel** are consumed. As such, a thrust
...
**within an infinite loop**, the program must read the data from the standard
input related to Mars Lander's current state and provide to the standard output
